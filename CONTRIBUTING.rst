...
#. The ```.codespellrc`` file<https://github.com/codespell-project/codespell#using-a-config-file>`_ can be used fix any codespell issues, such as ignoring certain files, directories, or regular expressions.
